...
export const DEFAULT_TEACHER_PROFILE: TeacherProfile = {
  ...
  namaSekolah: 'SMP / MTs Prestasi Bangsa',
  mataPelajaran: 'Matematika',
  tingkatKelas: 'Kelas IX E',
  semester: 'Ganjil',
...
export const SAMPLE_STUDENTS: Student[] = [
  { id: 'std-01', studentNo: '120101001', name: 'Aditya Pratama', classId: 'IX E', gender: 'L' },
  { id: 'std-02', studentNo: '120101002', name: 'Aisyah Putri Rahmadani', classId: 'IX E', gender: 'P' },
  { id: 'std-03', studentNo: '120101003', name: 'Bagas Dwi Wicaksono', classId: 'IX E', gender: 'L' },
  { id: 'std-04', studentNo: '120101004', name: 'Cantika Dewi Lestari', classId: 'IX E', gender: 'P' },
  { id: 'std-05', studentNo: '120101005', name: 'Dimas Arya Nugraha', classId: 'IX E', gender: 'L' },
  { id: 'std-06', studentNo: '120101006', name: 'Eka Nur Fitriani', classId: 'IX F', gender: 'P' },
  { id: 'std-07', studentNo: '120101007', name: 'Fajar Hidayatullah', classId: 'IX F', gender: 'L' },
  { id: 'std-08', studentNo: '120101008', name: 'Gita Maharani Putri', classId: 'IX F', gender: 'P' },
  { id: 'std-09', studentNo: '120101009', name: 'Hafiz Ananda Putra', classId: 'IX F', gender: 'L' },
  { id: 'std-10', studentNo: '120101010', name: 'Indah Kusuma Wardani', classId: 'IX F', gender: 'P' },
  { id: 'std-11', studentNo: '120101011', name: 'Jovan Nathaniel', classId: 'IX G', gender: 'L' },
  { id: 'std-12', studentNo: '120101012', name: 'Khansa Nabila Zahra', classId: 'IX G', gender: 'P' },
  { id: 'std-13', studentNo: '120101013', name: 'Lukman Hakim Siregar', classId: 'IX G', gender: 'L' },
  { id: 'std-14', studentNo: '120101014', name: 'Maya Anggraini', classId: 'IX G', gender: 'P' },
  { id: 'std-15', studentNo: '120101015', name: 'Naufal Rizky Maulana', classId: 'IX G', gender: 'L' },
  { id: 'std-16', studentNo: '120101016', name: 'Olivia Salsabila', classId: 'IX H', gender: 'P' },
  { id: 'std-17', studentNo: '120101017', name: 'Panji Gumilang Pangestu', classId: 'IX H', gender: 'L' },
  { id: 'std-18', studentNo: '120101018', name: 'Qonita Salma Fauziyyah', classId: 'IX H', gender: 'P' },
  { id: 'std-19', studentNo: '120101019', name: 'Rian Syahputra', classId: 'IX H', gender: 'L' },
  { id: 'std-20', studentNo: '120101020', name: 'Siti Nurhaliza', classId: 'IX H', gender: 'P' },
  { id: 'std-21', studentNo: '120101021', name: 'Taufiqurrahman', classId: 'IX I', gender: 'L' },
  { id: 'std-22', studentNo: '120101022', name: 'Utami Rahayu', classId: 'IX I', gender: 'P' },
  { id: 'std-23', studentNo: '120101023', name: 'Vicky Alexander', classId: 'IX I', gender: 'L' },
  { id: 'std-24', studentNo: '120101024', name: 'Wulan Maulida', classId: 'IX I', gender: 'P' },
  { id: 'std-25', studentNo: '120101025', name: 'Zidan Al-Ghifari', classId: 'IX I', gender: 'L' }
];
